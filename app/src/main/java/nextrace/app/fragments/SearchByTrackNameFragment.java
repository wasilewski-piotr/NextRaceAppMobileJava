 ...
 */
public class SearchByTrackNameFragment extends Fragment implements ClickListener {

    private RecyclerView recyclerView;
    private RecyclerViewRaceAdapter raceAdapter;
    private List<Race> raceList;

    public SearchByTrackNameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_search_by_track_name, container, false);

        EditText editText = (EditText) rootView.findViewById(R.id.editText_track);
        Button button = (Button) rootView.findViewById(R.id.button_find_track);
    ...
    public void getData(View view, String value){
        recyclerView = (RecyclerView) view.findViewById(R.id.item_race_list_by_track);
        ...
        Call<List<Race>> call = raceApi.getRacesByTrackName(value);
