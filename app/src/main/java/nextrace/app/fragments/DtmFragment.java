...
public class DtmFragment extends Fragment implements ClickListener {
    ...
    public void getData(View view){
        recyclerView = (RecyclerView) view.findViewById(R.id.item_race_list_dtm);
        ...
        Call<List<Race>> call = raceApi.getRacesDTM();
