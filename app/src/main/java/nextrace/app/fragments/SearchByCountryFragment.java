 ...
 */
public class SearchByCountryFragment extends Fragment implements ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_search_by_country, container, false);

        EditText editText = (EditText) rootView.findViewById(R.id.editText_country);
        Button button = (Button) rootView.findViewById(R.id.button_find_country);
    ...
    public void getData(View view, String value){
        recyclerView = (RecyclerView) view.findViewById(R.id.item_race_list_by_country);
        ...
        Call<List<Race>> call = raceApi.getRacesByCountryName(value);
