...
public class Formula1Fragment extends Fragment implements ClickListener {

    private RecyclerView recyclerView;
    private RecyclerViewRaceAdapter raceAdapter;
    private List<Race> raceList;

    public Formula1Fragment() {
    ...
    public void getData(View view){
        recyclerView = (RecyclerView) view.findViewById(R.id.item_race_list_formula_1);
        ...
        Call<List<Race>> call = raceApi.getRacesFormula1();
