...
public class FormulaEFragment extends Fragment implements ClickListener {
    ...
    public void getData(View view){
        recyclerView = (RecyclerView) view.findViewById(R.id.item_race_list_formula_e);
        ...
        Call<List<Race>> call = raceApi.getRacesFormulaE();
